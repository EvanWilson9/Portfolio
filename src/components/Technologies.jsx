  ...
  return (
    <section className='technologies-section'>
      ...
      <div className='technology-category'>
          <div className='technology-category-title'>Languages</div>
        ...
        <div className='technology-category'>
          <div className='technology-category-title'>Backend</div>
          <div className='technology-category-items'>
        ...
        <div className='technology-category'>
          <div className='technology-category-title'>Frontend</div>
          <div className='technology-category-items'>
        ...
        <div className='technology-category'>
          <div className='technology-category-title'>Tools</div>
          <div className='technology-category-items'>
